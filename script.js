$(function () {
	...
	var checkboxes = $('#subNav input[type=checkbox]');
	...
	function generateAllProductsHTML(data){
		...
		var theTemplateScript2 = $("#products-templates").html();
		//Compile the template​
		var theTemplate2 = Handlebars.compile (theTemplateScript2);
		list.append (theTemplate2(data));
	...
	function renderProductsPage(data){
		...
		var page = $('.all-products'),
			allProducts = $('#filterData .list > li');
